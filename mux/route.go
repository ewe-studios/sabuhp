...
func (m headerMatcher) Match(r *Request, match *RouteMatch) bool {
	return matchMapWithString(m, r.Headers, true)
}
...
func (m headerRegexMatcher) Match(r *Request, match *RouteMatch) bool {
	return matchMapWithRegex(m, r.Headers, true)
}
...
func (m schemeMatcher) Match(r *Request, match *RouteMatch) bool {
	scheme := r.URL.Scheme
